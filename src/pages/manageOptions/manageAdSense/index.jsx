  ...
  const adSenseList = async () => {
    ...
    if (response.remote === "success") {
      ...
      const formattedData = formatData.map((item) => {
        ...
        const formattedPageName = item.pageName.replace(
          /([a-z])([A-Z])/g,
          "$1 $2"
        );
        // Uppercase the first letter of the formatted pageName
        const uppercasedPageName =
          formattedPageName.charAt(0).toUpperCase() +
          formattedPageName.slice(1);
